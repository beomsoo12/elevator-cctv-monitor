"""Train cargo detection model (binary: empty vs loaded)."""
...
DATASET_DIR = "dataset/cargo"
MODEL_PATH = "models/cargo_model.keras"
...
def plot_history(history, save_path):
    ...
    ax1.set_title("Cargo Model - Accuracy")
    ...
    ax2.set_title("Cargo Model - Loss")
...
def main():
    ...
    for cls in ["empty", "loaded"]:
        ...
        if count < 10:
            print(f"WARNING: Very few images for '{cls}'. Recommend at least 200.")
    ...
    plot_history(ch, os.path.join(HISTORY_DIR, "cargo_history.png"))
    ...
    if val_acc < TARGET_ACCURACY:
        ...
        print("Consider collecting more training data or adjusting augmentation.")
    else:
